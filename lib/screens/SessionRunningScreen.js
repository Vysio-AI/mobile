...
const SessionRunningScreen = ({route, navigation}) => {
  ...
  return (
    <View style={tailwind('h-full w-full flex flex-col items-center bg-gray-50')}>
      ...
      />
      <View style={tailwind('absolute top-1 left-1')}>
        <Text style={tailwind('text-white text-sm')}>Debug Info</Text>
      ...
      <View style={tailwind('absolute bottom-10')}>
        ...
        <Text style={tailwind('text-white text-base')}>Current Activity Classification: {exerciseMap[currentClassification]}</Text>
